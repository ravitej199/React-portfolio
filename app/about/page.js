...
export default function About(){
    ...
    <div className=" max-md:!block flex items-center justify-around">
        ...
        <div className="hover:bg-black/30 group backdrop-blur-sm bg-black/20 max-md:!border-transparent max-md:w-[95vw] text-3xl p-10 w-[40vw] text-justify rounded-[20px] transition duration-400 border-4 border-[#244f75] border-r-[#1eb2d2] border-b-[#1eb2d2] hover:border-[#1b2a36]">
    ...
    {tags.map((tag, tIndex)=>
    <div key={tIndex} className="p-5 text-lg font-medium max-md:!block flex gap-5">
